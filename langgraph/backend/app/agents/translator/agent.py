...
from .schema import TranslationResult
...
def build_agent(
    ...
    *,
    ...
    agent_prompt = build_agent_prompt(AGENT_NAME, ["system"], False)
    ...
    agent = create_agent(
        ...
        response_format=TranslationResult,  # optional, for structured output
    )
    return agent
