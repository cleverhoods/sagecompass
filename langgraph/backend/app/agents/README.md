...
- If `few-shots.prompt` exists, it SHOULD be wired via template rendering **paired with `examples.json` containing at least one example and a trailing user stub**.
