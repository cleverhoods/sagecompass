...
- There is **no dedicated HILP node**. Clarifications are collected by agent middleware via `runtime.human(...)`.
...
- The supervisor routes between language detection, problem framing, and translation only.
