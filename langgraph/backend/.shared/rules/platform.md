...
- Validate phase registries with `validate_phase_registry` (`app/platform/core/contract/phases.py`).
- Validate agent schemas with `validate_agent_schema` (`app/platform/core/contract/agents.py`).
